                ...
                <form action="{{route('price.update',$price->id)}}" method='post' enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" value="{{$price->old_price}}" name='old_price' placeholder="Enter Old Price">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" value="{{$price->price}}" name='price' class="form-control">
                            @if($errors->has('price'))
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{$price->unit}}" name='unit' class="form-control">
                            @if($errors->has('unit'))
