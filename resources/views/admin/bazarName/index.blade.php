...
<div class="row justify-content-center">
    <div class="col-10">
        ...
        @endif
        <a href="{{route('bazarname.create')}}" class='btn btn-primary mb-3'>Add Bazar Name</a>
        <div class="card">
                ...
                <table class="table table-head-fixed text-nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{route('bazarname.edit',$bazar->id)}}" class='btn btn-primary'>Edit</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
